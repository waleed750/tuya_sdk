...
public class FlutterTuyaSdkPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let instance = FlutterTuyaSdkPlugin()
        let methodChannel = FlutterMethodChannel(
            name: "flutter_tuya_sdk",
            binaryMessenger: registrar.messenger()
        )
        registrar.addMethodCallDelegate(instance, channel: methodChannel)
        
        let eventChannel = FlutterEventChannel(
            name: "flutter_tuya_sdk/pairingEvents",
            binaryMessenger: registrar.messenger()
        )
...
extension FlutterTuyaSdkPlugin: FlutterStreamHandler {
...
extension FlutterTuyaSdkPlugin: ThingSmartBLEManagerDelegate {
...
extension FlutterTuyaSdkPlugin: ThingSmartActivatorDelegate {
...
extension FlutterTuyaSdkPlugin: ThingSmartDeviceDelegate {

...
import 'flutter_tuya_sdk_platform_interface.dart';

/// Flutter plugin for Tuya Home Automation.
///
/// Wraps the native Tuya Smart Home SDKs on Android and iOS via
/// `MethodChannel`/`EventChannel` (`flutter_tuya_sdk` /
/// `flutter_tuya_sdk/pairingEvents`). Exposes user, home, device-pairing,
/// device-control, room, smart-lock and camera/IPC APIs. See `README.md`
/// Prerequisites before use.
class FlutterTuyaSdk {
  /// Returns the platform version, e.g. "Android 14" or "iOS 18.0".
  Future<String?> getPlatformVersion() {
    return FlutterTuyaSdkPlatform.instance.getPlatformVersion();
  }
  ...
  static Future<void> tuyaSdkInit({
    ...
    if (Platform.isAndroid) {
      ...
      return FlutterTuyaSdkPlatform.instance.tuyaSdkInit(
        appKey: androidKey,
  ...
  static Future<Map<String, dynamic>> loginWithUid({
    ...
    return FlutterTuyaSdkPlatform.instance.loginWithUid(
  ...
  static Future<Map<String, dynamic>> loginWithEmail({
    ...
    return FlutterTuyaSdkPlatform.instance.loginWithEmail(
      countryCode: countryCode,
      email: email,
      password: password,
      createHome: createHome,
  ...
  static Future<bool> checkLogin() {
    return FlutterTuyaSdkPlatform.instance.checkLogin();
  }
  ...
  static Future<ThingSmartUserModel> getCurrentUser() async {
    var res = await FlutterTuyaSdkPlatform.instance.getCurrentUser();
    print(res);
  ...
  static Future<void> userLogout() {
    return FlutterTuyaSdkPlatform.instance.userLogout();
  }
  ...
  static Future<void> sendVerificationCode({
    ...
    return FlutterTuyaSdkPlatform.instance.sendVerificationCode(
      countryCode: countryCode,
      account: account,
  ...
  static Future<Map<String, dynamic>> registerAccountWithEmail({
    ...
    return FlutterTuyaSdkPlatform.instance.registerAccountWithEmail(
      countryCode: countryCode,
      email: email,
      password: password,
      code: code,
  ...
  static Future<Map<String, dynamic>> registerAccountWithPhone({
    ...
    return FlutterTuyaSdkPlatform.instance.registerAccountWithPhone(
      countryCode: countryCode,
      phone: phone,
      password: password,
      code: code,
  ...
  static Future<void> deleteAccount() {
    return FlutterTuyaSdkPlatform.instance.deleteAccount();
  }
  ...
  static Future<void> updateTimeZone({required String timeZoneId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.updateTimeZone(
  ...
  static Future<void> updateTempUnit({required int tempUnit}) {
    ...
    return FlutterTuyaSdkPlatform.instance.updateTempUnit(tempUnit: tempUnit);
  }
  ...
  static Future<void> updateNickname({required String nickname}) {
    ...
    return FlutterTuyaSdkPlatform.instance.updateNickname(nickname: nickname);
  }
  ...
  static Future<int> createHome({
    ...
    return FlutterTuyaSdkPlatform.instance.createHome(
      name: name,
      geoName: geoName,
      rooms: rooms,
      latitude: latitude,
  ...
  static Future<List<Map<String, dynamic>>> getHomeList() {
    return FlutterTuyaSdkPlatform.instance.getHomeList();
  }
  ...
  static Future<void> updateHomeInfo({
    ...
    return FlutterTuyaSdkPlatform.instance.updateHomeInfo(
      homeId: homeId,
      homeName: homeName,
      geoName: geoName,
      latitude: latitude,
  ...
  static Future<void> deleteHome({required int homeId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.deleteHome(homeId: homeId);
  }
  ...
  static Future<List<Map<String, dynamic>>> getHomeDevices({
    ...
    return FlutterTuyaSdkPlatform.instance.getHomeDevices(homeId: homeId);
  }
  ...
  static const EventChannel _pairingEventChannel = EventChannel(
    'flutter_tuya_sdk/pairingEvents',
  );
  ...
  static Future<String?> getSSID() {
    return FlutterTuyaSdkPlatform.instance.getSSID();
  }
  ...
  static Future<void> updateLocation({
    ...
    return FlutterTuyaSdkPlatform.instance.updateLocation(
      latitude: latitude,
      longitude: longitude,
    );
  }
  ...
  static Future<String?> getToken({required int homeId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.getToken(homeId: homeId);
  }
  ...
  static Future<Map<String, dynamic>?> startConfigWiFi({
    ...
    return FlutterTuyaSdkPlatform.instance.startConfigWiFi(
      mode: mode,
      ssid: ssid,
      password: password,
      token: token,
  ...
  static Future<void> stopConfigWiFi() {
    return FlutterTuyaSdkPlatform.instance.stopConfigWiFi();
  }
  ...
  static Future<void> connectDeviceAndQueryWifiList({int timeout = 120}) {
    return FlutterTuyaSdkPlatform.instance.connectDeviceAndQueryWifiList(
      timeout: timeout,
    );
  }
  ...
  static Future<void> resumeAPPlus({
    ...
    return FlutterTuyaSdkPlatform.instance.resumeAPPlus(
      ssid: ssid,
      password: password,
      token: token,
      timeout: timeout,
  ...
  static Future<Map<String, dynamic>?> discoverDeviceInfo() {
    return FlutterTuyaSdkPlatform.instance.discoverDeviceInfo();
  }
  ...
  static Future<void> stopAnyPairingOrScan() {
    return FlutterTuyaSdkPlatform.instance.stopAnyPairingOrScan();
  }
  ...
  static Future<Map<String, dynamic>?> smartBlePairing({
    ...
    return FlutterTuyaSdkPlatform.instance.smartBlePairing(
      homeId: homeId,
  ...
  static Future<Map<String, dynamic>?> pairBleDevice({
    ...
    return FlutterTuyaSdkPlatform.instance.pairBleDevice(
      uuid: uuid,
      productId: productId,
      homeId: homeId,
  ...
  static Future<Map<String, dynamic>?> startComboPairing({
    ...
    return FlutterTuyaSdkPlatform.instance.startComboPairing(
      uuid: uuid,
      productId: productId,
      homeId: homeId,
      ssid: ssid,
  ...
  /// FlutterTuyaSdk.pairingEvents.listen((event) {
  ...
  /// Map<String, dynamic>? result = await FlutterTuyaSdk.wifiBleComboConfig(
  ///   ssid: "MyWiFi",
  ...
  static Future<Map<String, dynamic>?> wifiBleComboConfig({
    ...
    return FlutterTuyaSdkPlatform.instance.wifiBleComboConfig(
      ssid: ssid,
      homeId: homeId,
      password: password,
      token: token,
  ...
  static Future<void> initDevice({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.initDevice(devId: devId);
  }
  ...
  static Future<Map<String, dynamic>?> queryDeviceInfo({
    ...
    return FlutterTuyaSdkPlatform.instance.queryDeviceInfo(
      devId: devId,
      dps: dps,
    );
  }
  ...
  static Future<void> renameDevice({
    ...
    return FlutterTuyaSdkPlatform.instance.renameDevice(
      devId: devId,
      name: name,
    );
  }
  ...
  static Future<void> removeDevice({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.removeDevice(devId: devId);
  }
  ...
  static Future<void> restoreFactoryDefaults({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.restoreFactoryDefaults(
      devId: devId,
    );
  }
  ...
  static Future<String?> queryDeviceWiFiStrength({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.queryDeviceWiFiStrength(
      devId: devId,
    );
  }
  ...
  static Future<Map<String, dynamic>?> querySubDeviceList({
    ...
    return FlutterTuyaSdkPlatform.instance.querySubDeviceList(devId: devId);
  }
  ...
  static Future<List<Map<String, dynamic>>?> getRoomList({
    ...
    return FlutterTuyaSdkPlatform.instance.getRoomList(homeId: homeId);
  }
  ...
  static Future<void> addRoom({required int homeId, required String roomName}) {
    ...
    return FlutterTuyaSdkPlatform.instance.addRoom(
      homeId: homeId,
      roomName: roomName,
    );
  }
  ...
  static Future<void> removeRoom({required int homeId, required int roomId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.removeRoom(
      homeId: homeId,
      roomId: roomId,
    );
  }
  ...
  static Future<void> sortRooms({
    ...
    return FlutterTuyaSdkPlatform.instance.sortRooms(
      homeId: homeId,
      roomIds: roomIds,
    );
  }
  ...
  static Future<void> updateRoomName({
    ...
    return FlutterTuyaSdkPlatform.instance.updateRoomName(
      homeId: homeId,
      roomId: roomId,
      roomName: roomName,
    );
  ...
  static Future<void> addDeviceToRoom({
    ...
    return FlutterTuyaSdkPlatform.instance.addDeviceToRoom(
      homeId: homeId,
      roomId: roomId,
      devId: devId,
    );
  ...
  static Future<void> removeDeviceFromRoom({
    ...
    return FlutterTuyaSdkPlatform.instance.removeDeviceFromRoom(
      homeId: homeId,
      roomId: roomId,
      devId: devId,
    );
  ...
  static Future<void> addGroupToRoom({
    ...
    return FlutterTuyaSdkPlatform.instance.addGroupToRoom(
      homeId: homeId,
      roomId: roomId,
      groupId: groupId,
    );
  ...
  static Future<void> removeGroupFromRoom({
    ...
    return FlutterTuyaSdkPlatform.instance.removeGroupFromRoom(
      homeId: homeId,
      roomId: roomId,
      groupId: groupId,
    );
  ...
  static Future<void> unlockBLELock({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.unlockBLELock(devId: devId);
  }
  ...
  static Future<void> lockBLELock({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.lockBLELock(devId: devId);
  }
  ...
  static Future<void> replyRequestUnlock({
    ...
    return FlutterTuyaSdkPlatform.instance.unlockWifiLock(
      devId: devId,
      open: open,
    );
  }
  ...
  static Future<void> lockWifiLock({required String devId}) {
    return FlutterTuyaSdkPlatform.instance.lockWifiLock(devId: devId);
  }
  ...
  static Future<String> dynamicWifiLockPassword({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.dynamicWifiLockPassword(
      devId: devId,
    );
  }
  ...
  static Future<bool> checkIsMatter({required String devId}) {
    ...
    return FlutterTuyaSdkPlatform.instance.checkIfMatter(devId: devId);
  }
  ...
  static Future<void> controlMatter({
    ...
    return FlutterTuyaSdkPlatform.instance.controlMatter(
      devId: devId,
      dps: dps,
    );
  }
  ...
  static Future<void> setRemoteUnlockListener(String devId) {
    return FlutterTuyaSdkPlatform.instance.setRemoteUnlockListener(devId);
  }

  /// Replies to a remote unlock request.
  static Future<void> replyRemoteUnlock(String devId, bool allow) {
    return FlutterTuyaSdkPlatform.instance.replyRemoteUnlock(devId, allow);
  }

  /// Stream for remote unlock requests.
  static Stream<Map<String, dynamic>>? get remoteUnlockEventStream =>
      FlutterTuyaSdkPlatform.instance.remoteUnlockEventStream;
}

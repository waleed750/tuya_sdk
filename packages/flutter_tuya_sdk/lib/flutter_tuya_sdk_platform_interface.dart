...
import 'flutter_tuya_sdk_method_channel.dart';

abstract class FlutterTuyaSdkPlatform extends PlatformInterface {
  /// Constructs a FlutterTuyaSdkPlatform.
  FlutterTuyaSdkPlatform() : super(token: _token);

  static final Object _token = Object();

  static FlutterTuyaSdkPlatform _instance = MethodChannelFlutterTuyaSdk();

  /// The default instance of [FlutterTuyaSdkPlatform] to use.
  ///
  /// Defaults to [MethodChannelFlutterTuyaSdk].
  static FlutterTuyaSdkPlatform get instance => _instance;

  /// Platform-specific plugins should register themselves by calling this setter.
  static set instance(FlutterTuyaSdkPlatform instance) {
  ...
  /// Sends a verification code to [account].
  ///
  /// [accountType] determines how the request is sent on the native side. Pass
  /// "email" to send an email verification code or "phone" to send a SMS code.
  /// The [countryCode] should match the account’s country prefix. Optionally a
  /// [type] can be provided to specify the Tuya/Thing validation use-case (for
  /// example `1` for registration). When omitted the default registration type
  /// is used by the native SDKs.
  ...
  Future<void> deleteDevice({required String devId});
